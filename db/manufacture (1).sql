...
--
-- Host: 127.0.0.1
-- Generation Time: 09 Apr 2018 pada 00.01
...
--
-- Struktur dari tabel `app_category`
--
...
--
-- Dumping data untuk tabel `app_category`
--

INSERT INTO `app_category` (`app_category_id`, `name`) VALUES
(1, 'test'),
(2, 'test2');
...
--
-- Struktur dari tabel `app_category_raw_material`
--

CREATE TABLE `app_category_raw_material` (
  `app_category_raw_material_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `app_category_raw_material`
--

INSERT INTO `app_category_raw_material` (`app_category_raw_material_id`, `name`) VALUES
(1, 'Bahan Pokok'),
(2, 'Bahan Tambahan'),
(3, 'Bahan Pokok');
...
CREATE TABLE `app_products` (
  `app_product_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `app_suplier_id` int(11) NOT NULL,
...
INSERT INTO `app_products` (`app_product_id`, `name`, `app_suplier_id`, `app_category_id`, `unit`, `unit_price`) VALUES
(2, 'kaos lengan panjang', 0, 1, 'potong', 70000),
(3, 'kemeja lengan panjang', 0, 1, 'potong', 40000),
(4, 'celana levis KW', 0, 2, 'potong', 30000);

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_product_composition`
--

CREATE TABLE `app_product_composition` (
  `app_product_composition_id` int(11) NOT NULL,
  `app_product_id` int(11) NOT NULL,
  `data_composition` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `app_product_composition`
--

INSERT INTO `app_product_composition` (`app_product_composition_id`, `app_product_id`, `data_composition`) VALUES
(16, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"},{\"app_raw_material_id\":\"102\",\"amount\":\"3\"}]'),
(17, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"},{\"app_raw_material_id\":\"102\",\"amount\":\"3\"}]'),
(18, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"},{\"app_raw_material_id\":\"102\",\"amount\":\"3\"}]'),
(19, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"},{\"app_raw_material_id\":\"102\",\"amount\":\"3\"}]'),
(20, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"},{\"app_raw_material_id\":\"102\",\"amount\":\"3\"}]'),
(21, 2, '[{\"app_raw_material_id\":\"100\",\"amount\":\"1\"},{\"app_raw_material_id\":\"101\",\"amount\":\"2\"}]');

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_purchase`
--

CREATE TABLE `app_purchase` (
  `app_purchase_id` int(10) UNSIGNED NOT NULL,
  `app_suplier_id` int(11) NOT NULL,
  `sys_user_id` int(11) NOT NULL,
  `purchase_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `purchase_date` date NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `app_purchase`
--

INSERT INTO `app_purchase` (`app_purchase_id`, `app_suplier_id`, `sys_user_id`, `purchase_number`, `purchase_date`, `description`) VALUES
(20, 2, 0, 'PU000020', '2018-03-14', 'testing'),
(22, 3, 0, 'PU000022', '2018-04-04', 'beli tepung terigu'),
(23, 1, 0, 'PU000023', '2018-04-04', 'fasdfadsf'),
(24, 1, 0, 'PU000024', '2018-04-04', 'untuk produksi roti'),
(25, 1, 0, 'PU000025', '2018-04-07', 'testttt');

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_purchase_detail`
--

CREATE TABLE `app_purchase_detail` (
  `app_purchase_detail_id` int(10) UNSIGNED NOT NULL,
  `app_purchase_id` int(11) NOT NULL,
  `app_raw_material_id` int(11) NOT NULL,
  `qty` int(6) NOT NULL,
  `sub_total` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `app_purchase_detail`
--

INSERT INTO `app_purchase_detail` (`app_purchase_detail_id`, `app_purchase_id`, `app_raw_material_id`, `qty`, `sub_total`) VALUES
(54, 18, 100, 4, 80000),
(55, 18, 103, 3, 150000),
(56, 21, 100, 2, 40000),
(57, 23, 100, 3, 60000),
...
--
-- Struktur dari tabel `app_raw_material`
--

CREATE TABLE `app_raw_material` (
  `app_raw_material_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `app_suplier_id` int(11) NOT NULL,
  `app_category_raw_material_id` int(11) NOT NULL,
  `unit` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `app_raw_material`
--

INSERT INTO `app_raw_material` (`app_raw_material_id`, `name`, `app_suplier_id`, `app_category_raw_material_id`, `unit`, `unit_price`, `description`) VALUES
(100, 'kain mor putih', 1, 1, 'meter', 20000, 'bahan untuk kemeja '),
(101, 'kain famatex', 9, 1, 'meter', 50000, 'kain untuk celamna formal'),
(102, 'kain nilon', 9, 2, 'meter', 30000, ''),
(103, 'kain wol', 9, 1, 'meter', 50000, '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_return_purchase`
--

CREATE TABLE `app_return_purchase` (
  `app_return_purchase_id` int(10) UNSIGNED NOT NULL,
  `suplier_id` int(11) NOT NULL,
  `sys_user_id` int(11) NOT NULL,
  `return_purchase_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `return_date` date NOT NULL,
  `return_reason` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Struktur dari tabel `app_return_purchase_detail`
--

CREATE TABLE `app_return_purchase_detail` (
  `app_return_purchase_detail_id` int(10) UNSIGNED NOT NULL,
  `app_return_purchase_id` int(11) NOT NULL,
  `app_product_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Struktur dari tabel `app_return_sales`
--

CREATE TABLE `app_return_sales` (
  `app_return_sales_id` int(10) UNSIGNED NOT NULL,
  `customer_id` int(11) NOT NULL,
  `sys_user_id` int(11) NOT NULL,
  `return_sales_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `return_date` date NOT NULL,
  `return_reason` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Struktur dari tabel `app_return_sales_detail`
--

CREATE TABLE `app_return_sales_detail` (
  `app_return_sales_detail_id` int(10) UNSIGNED NOT NULL,
  `app_return_sales_id` int(11) NOT NULL,
  `app_product_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Struktur dari tabel `app_sales`
--

CREATE TABLE `app_sales` (
  `app_sales_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data untuk tabel `app_sales`
--

INSERT INTO `app_sales` (`app_sales_id`, `invoice_number`, `sale_date`, `customer_id`, `sys_user_id`, `customer_name`) VALUES
(2, 'INV000002', '2018-04-03', 0, 0, 'Wayan ccc'),
(4, 'INV000003', '2018-04-04', 0, 0, 'agung'),
(6, 'INV000006', '2018-04-06', 0, 0, 'yusuf11'),
(7, 'INV000007', '2018-04-06', 0, 0, 'asdfdasf');

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_sales_detail`
--

CREATE TABLE `app_sales_detail` (
  `app_sales_detail_id` int(10) UNSIGNED NOT NULL,
  `app_sales_id` int(11) NOT NULL,
  `app_product_id` int(11) NOT NULL,
  `qty` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `app_sales_detail`
--

INSERT INTO `app_sales_detail` (`app_sales_detail_id`, `app_sales_id`, `app_product_id`, `qty`, `sub_total`) VALUES
(23, 6, 2, 2, 140000),
(24, 6, 3, 2, 140000),
(25, 6, 4, 1, 30000),
(42, 2, 2, 1, 70000),
...
--
-- Struktur dari tabel `app_stock`
--

CREATE TABLE `app_stock` (
  `app_stock_id` int(10) UNSIGNED NOT NULL,
  `app_product_id` int(11) NOT NULL,
  `stock` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `app_stock`
--

INSERT INTO `app_stock` (`app_stock_id`, `app_product_id`, `stock`) VALUES
(1, 2, 22),
(2, 3, 37);
...
--
-- Struktur dari tabel `app_stock_raw_material`
--

CREATE TABLE `app_stock_raw_material` (
  `app_stock_raw_material_id` int(10) UNSIGNED NOT NULL,
  `app_raw_material_id` int(11) NOT NULL,
  `stock` int(6) NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Dumping data untuk tabel `app_stock_raw_material`
--

INSERT INTO `app_stock_raw_material` (`app_stock_raw_material_id`, `app_raw_material_id`, `stock`, `description`) VALUES
(8, 100, 36, ''),
(9, 101, 29, ''),
(10, 103, 19, ''),
(11, 102, 5, 'sdfsda');
...
--
-- Struktur dari tabel `app_suplier`
--

CREATE TABLE `app_suplier` (
  `app_suplier_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `app_suplier`
--

INSERT INTO `app_suplier` (`app_suplier_id`, `name`, `addres`, `telephone_number`) VALUES
(1, 'Abdullah', 'Bandung', '087584375'),
(2, 'Jhony', 'Bandung', '087584375'),
(3, 'Anita', 'Semarang', '087584375'),
(4, 'Mahmud', 'Solo', '087584375'),
(5, 'Antoni', 'Tangerang', '087584375'),
(6, 'testing', 'shguhsdf', 'fjeoirjgier'),
(9, 'Rizqi', 'Jl.tb simatupang', '083807250726'),
(10, 'soleha ', 'batang', '0375t0934');
...
('2017_11_11_180322_sys_users', 1),
('2017_11_11_181254_sys_roles', 1),
('2017_11_11_184430_app_suplier', 1),
('2017_11_11_185028_app_product', 1),
('2017_11_11_202538_app_stock', 1),
('2017_11_11_203755_app_category', 1),
('2017_11_11_204321_app_sales', 1),
('2017_11_11_205953_app_sales_detail', 1),
('2017_11_11_211905_app_purchase', 1),
('2017_11_11_212402_app_purchase_detail', 1),
('2017_11_11_213346_app_return_purchase', 1),
('2017_11_11_215741_app_return_purchase_detail', 1),
('2017_11_11_220204_app_return_sales_detail', 1),
('2017_11_11_220658_app_return_sales', 1),
('2017_11_12_013903_add_password_to_sys_users', 1),
('2017_11_12_023501_create_dashboards_table', 1),
('2017_11_12_183435_app_raw_material', 2),
('2017_11_12_185256_app_stock_raw_material', 2),
('2017_11_12_185403_app_category_raw_material', 2);
...
(4120, 'Midlands', 246),
(4121, 'Kaboul', 1),
(4122, 'value of second country', 2);
...
(1, 'Abdullar', 1, 'manajer', 'admin'),
(2, 'Anton', 2, 'admin', 'admin'),
(3, 'Fauzan', 3, 'admin2', 'admin'),
(4, 'Andi', 4, 'Kepala Gudang', 'admin'),
(5, 'siska', 5, 'Accounting', 'admin');
...
ALTER TABLE `app_category`
  ADD PRIMARY KEY (`app_category_id`);

--
-- Indexes for table `app_category_raw_material`
--
ALTER TABLE `app_category_raw_material`
  ADD PRIMARY KEY (`app_category_raw_material_id`);

--
-- Indexes for table `app_products`
--
ALTER TABLE `app_products`
  ADD PRIMARY KEY (`app_product_id`);

--
-- Indexes for table `app_product_composition`
--
ALTER TABLE `app_product_composition`
  ADD PRIMARY KEY (`app_product_composition_id`);

--
-- Indexes for table `app_purchase`
--
ALTER TABLE `app_purchase`
  ADD PRIMARY KEY (`app_purchase_id`);

--
-- Indexes for table `app_purchase_detail`
--
ALTER TABLE `app_purchase_detail`
  ADD PRIMARY KEY (`app_purchase_detail_id`);

--
-- Indexes for table `app_raw_material`
--
ALTER TABLE `app_raw_material`
  ADD PRIMARY KEY (`app_raw_material_id`);

--
-- Indexes for table `app_return_purchase`
--
ALTER TABLE `app_return_purchase`
  ADD PRIMARY KEY (`app_return_purchase_id`);

--
-- Indexes for table `app_return_purchase_detail`
--
ALTER TABLE `app_return_purchase_detail`
  ADD PRIMARY KEY (`app_return_purchase_detail_id`);

--
-- Indexes for table `app_return_sales`
--
ALTER TABLE `app_return_sales`
  ADD PRIMARY KEY (`app_return_sales_id`);

--
-- Indexes for table `app_return_sales_detail`
--
ALTER TABLE `app_return_sales_detail`
  ADD PRIMARY KEY (`app_return_sales_detail_id`);

--
-- Indexes for table `app_sales`
--
ALTER TABLE `app_sales`
  ADD PRIMARY KEY (`app_sales_id`);

--
-- Indexes for table `app_sales_detail`
--
ALTER TABLE `app_sales_detail`
  ADD PRIMARY KEY (`app_sales_detail_id`);

--
-- Indexes for table `app_stock`
--
ALTER TABLE `app_stock`
  ADD PRIMARY KEY (`app_stock_id`);

--
-- Indexes for table `app_stock_raw_material`
--
ALTER TABLE `app_stock_raw_material`
  ADD PRIMARY KEY (`app_stock_raw_material_id`);

--
-- Indexes for table `app_suplier`
--
ALTER TABLE `app_suplier`
  ADD PRIMARY KEY (`app_suplier_id`);
...
--
ALTER TABLE `app_category`
  MODIFY `app_category_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `app_category_raw_material`
--
ALTER TABLE `app_category_raw_material`
  MODIFY `app_category_raw_material_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `app_products`
--
ALTER TABLE `app_products`
  MODIFY `app_product_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `app_product_composition`
--
ALTER TABLE `app_product_composition`
  MODIFY `app_product_composition_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `app_purchase`
--
ALTER TABLE `app_purchase`
  MODIFY `app_purchase_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `app_purchase_detail`
--
ALTER TABLE `app_purchase_detail`
  MODIFY `app_purchase_detail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT for table `app_raw_material`
--
ALTER TABLE `app_raw_material`
  MODIFY `app_raw_material_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
--
-- AUTO_INCREMENT for table `app_return_purchase`
--
ALTER TABLE `app_return_purchase`
  MODIFY `app_return_purchase_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `app_return_purchase_detail`
--
ALTER TABLE `app_return_purchase_detail`
  MODIFY `app_return_purchase_detail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `app_return_sales`
--
ALTER TABLE `app_return_sales`
  MODIFY `app_return_sales_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `app_return_sales_detail`
--
ALTER TABLE `app_return_sales_detail`
  MODIFY `app_return_sales_detail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `app_sales`
--
ALTER TABLE `app_sales`
  MODIFY `app_sales_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `app_sales_detail`
--
ALTER TABLE `app_sales_detail`
  MODIFY `app_sales_detail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT for table `app_stock`
--
ALTER TABLE `app_stock`
  MODIFY `app_stock_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `app_stock_raw_material`
--
ALTER TABLE `app_stock_raw_material`
  MODIFY `app_stock_raw_material_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `app_suplier`
--
ALTER TABLE `app_suplier`
  MODIFY `app_suplier_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `sys_roles`
  MODIFY `sys_roles_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `sys_users`
--
ALTER TABLE `sys_users`
  MODIFY `sys_user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
