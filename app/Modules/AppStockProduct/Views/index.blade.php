...
@section('content')
				...
				<tr @if($row_style % 2 ==0) class="odd" @else class="even"  @endif>
							...
							<td class=" ">
								...
								<div class="hidden-sm hidden-xs action-buttons">
									<a class="green" href="#" onclick="edit('{{$values['app_stock_id']}}')">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
									<a class="red" href="#" onclick="deleteData('{{$values['app_stock_id']}}')">
								...
								<div class="hidden-md hidden-lg">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											...
											<li>
												<a href="#" onclick="deleteData('{{$values['app_stock_id']}}')" class="tooltip-error" data-rel="tooltip" title="" data-original-title="Delete">
													<span class="red">
	...
	@include('AppStockProduct::create')
	@include('AppStockProduct::action_js')
	@include('AppStockProduct::edit')				
	@include('AppStockProduct::delete')		
@endsection