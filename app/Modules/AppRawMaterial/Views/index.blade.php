		...
		<div class="col-xs-12">
			...
			<div>
				...
				<tr @if($row_style % 2 ==0) class="odd" @else class="even"  @endif>
							...
							<td class=" ">{{Common::number_with_commas($values["unit_price"])}}</td>
							<td class="hidden-480">
								@if ($values["stock"] == "")
									<p>
								...
								<div class="hidden-md hidden-lg">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											<li>
												<a href="#" onclick="expandData('{{$values['app_raw_material_id']}}')" class="tooltip-error" data-rel="tooltip" title="" data-original-title="Delete">
													<span class="red">											
