	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-sm-12" style="display:none;">
							<div class="form-group">
								<label>Old Qty</label> 
								<input disabled type="text" readonly="readonly" value="" name="old_qty" id="old_qty" class="form-control"/>
							</div>						
						</div>
						<div class="col-sm-12">
							<div class="form-group">
			...
			<div class="modal-footer">
				<button type="button" data-dismiss="modal" type="button" class="btn btn-primary">Close</button>
			</div>										
		</div>
	</div>
</div>
