	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Expand Raw mterial</h4>
			</div>
			<div class="modal-body">
					<form name="frm-expand" id="frm-expand" action="{{url('suplier/destroy')}}" method="post">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="form-group">
								<label>Email</label> 
								<input type="text" disabled placeholder="" name="email" id="email" required="" class="form-control">
							</div>									
